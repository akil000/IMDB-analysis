...
# 10 (7171  słów): 44.2 + 40.7 = 84.9 %   
#  5 (11110 słów): 44.9 + 40.5 = 85.4 %   
# 15 (5533  słów): 44.0 + 41.0 = 85.0 %   
# 20 (4516  słów): 44.1 + 41.0 = 85.1 %     
# 25 (3939  słów): 43.8 + 41.1 = 84.9 %   
# 30 (3472  słów): 43.6 + 41.2 = 84.8 %   
...
# Dane: 10 000, Freq  20 : 44.1 + 41.0 = 85.1 %     
# Dane: 20 000, Freq  40 : 42.9 + 42.8 = 85.7 %     
# Dane: 50 000, Freq 100 : 41.8 + 42.4 = 84.2 %     
# KOMENTARZ: Znaczącej poprawy nie widać, wzrost przy 20 000 wynika z innych danych


### WYBÓR: 10 000, Laplace: 1, Freq: 20
# Wynik: 44.2 + 41.0 = 85.2 %    



#====== Drzewa decyzyjne ======

### BEZ WZMACNIANIA - 78.92 %   
...
drzewo <- C5.0(imdb_train, imdb_train_labels, trials=8)
summary(drzewo)
